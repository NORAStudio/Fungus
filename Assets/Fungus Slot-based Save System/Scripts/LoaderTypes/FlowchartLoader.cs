...
namespace CGTUnity.Fungus.SaveSystem
{
    ...
    public class FlowchartLoader : SaveLoader<FlowchartData>
    {
        ...
        protected virtual void LoadVariables(FlowchartData data, ref Flowchart flowchart)
        {
            ...
            ExecuteVariablesChanger(flowchart);
        }

        private void ExecuteVariablesChanger(Flowchart flowchart)
        {
            var blockNames = new[]
            {
                "ViewChanger", "MusicChanger", "AudioVolumeChanger", "PortraitLeftChanger", "PortraitRightChanger", 
                "PortraitMiddleChanger", "WantedPosterChanger", "WantedPosterClickableChanger", "Black80Changer",
                "BellClickableChanger", "BunnyClickableChanger", "ShoeRackClickableChanger", "HandleClickableChanger",
                "DoorHovChanger", "ClickToContinueChanger"
            };
